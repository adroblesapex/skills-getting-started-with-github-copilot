...
activities = {
    ...
    "Drama Club": {
        "description": "Theater production and acting workshops culminating in seasonal shows",
    ...
    "Science Olympiad": {
        "description": "Team-based science and engineering challenges preparing for regional meets",
